...
<body>
    ...
    >
      ...
      <div class="h-12 flex items-center gap-5">
        ...
        <a
          class="h-full px-6 flex justify-center items-center border border-black text-black transition duration-200 hover:bg-black hover:text-white"
    ...
    <!-- sidebar -->
    <nav
      class="fixed z-[998] left-0 top-16 bottom-0 w-[250px] bg-[#f2f2f6] p-2.5 flex flex-col gap-2.5"
    >
      <div class="w-full h-max flex flex-col gap-2">
        ...
        >
          ...
          <a
            class="group w-full h-10 flex justity-start items-center gap-2 pl-2.5 rounded-full text-gray-400 text-sm transition duration-200 hover:text-white hover:bg-black"
            href="#"
          >
            <i class="bi bi-house-fill hidden group-hover:block"></i>
            <i class="bi bi-house group-hover:hidden"></i>
