...
admin_header('Settings', 'settting.php');
page_title('Account', 'Store settings', 'Control the basics that appear across your store.');
?>
...
<form method="post" class="max-w-[calc(100vw-256px)] rounded-[28px] bg-[#f2f2f6] p-5">
    <div class="grid gap-4 sm:grid-cols-2"><label class="text-sm font-medium">Store name<input name="store_name"
                value="<?= e($settings['store_name'] ?? 'Solis Skin') ?>"
