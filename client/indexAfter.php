...
<body>
     <nav
      ...
      <div class="flex flex-row justify-between items-center pt-[6px]">
        ...
        <div class="relative h-max flex justify-center items-center">
          ...
          <a class="h-10 px-8 text-black border border-black text-sm flex justify-center items-center ml-5 transition duration-200 hover:text-white hover:bg-black" href="../auth/logout.php">Logout</a>
        </div>
      </div>
